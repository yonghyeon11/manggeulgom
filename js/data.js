...
const infoList = [
  ...
  {
    name: '결혼은 언제쯤 할까 신혼여행은 어디로?, 이상적인 연애관의 소유자 <청용 망그러진 곰>',
  ...
  {
    name: '기념일에 무슨 이벤트 할까, 이벤트 플래너 <루돌프 망그러진 곰>',
  ...
  {
    name: '이건 이거고 저건 저거지 , 공과사 확실한 <고양이 망그러진 곰>',
